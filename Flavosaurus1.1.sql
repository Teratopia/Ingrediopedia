...
CREATE TABLE IF NOT EXISTS `mydb`.`Ingredient` (
  ...
  `Recipe_User_idUser` INT NOT NULL,
  ...
  PRIMARY KEY (`Id`),
  INDEX `fk_Ingredient_Recipe1_idx` (`Recipe_Id` ASC, `Recipe_User_idUser` ASC),
  CONSTRAINT `fk_Ingredient_Recipe1`
    FOREIGN KEY (`Recipe_Id` , `Recipe_User_idUser`)
    REFERENCES `mydb`.`Recipe` (`Id` , `User_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE USER 'Admin' IDENTIFIED BY 'turnips';
