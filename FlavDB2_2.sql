...
-- CREATE USER 'TheCheese'@'localhost' IDENTIFIED BY 'shr1mp1ns1nthep0t';
-- 
-- GRANT ALL ON `flavosaurus2_1`.* TO 'TheCheese'@'localhost';
-- GRANT ALL ON `flavosaurusdb`.* TO 'TheCheese'@'localhost';
-- GRANT SELECT, INSERT, TRIGGER ON TABLE `flavosaurus2_1`.* TO 'TheCheese'@'localhost';
-- GRANT SELECT, INSERT, TRIGGER ON TABLE `flavosaurusdb`.* TO 'TheCheese'@'localhost';
-- GRANT SELECT, INSERT, TRIGGER, UPDATE, DELETE ON TABLE `flavosaurus2_1`.* TO 'TheCheese'@'localhost';
-- GRANT SELECT, INSERT, TRIGGER, UPDATE, DELETE ON TABLE `flavosaurusdb`.* TO 'TheCheese'@'localhost';
